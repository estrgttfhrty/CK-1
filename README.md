...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/estrgttfhrty/CK-1 ) 
...
|端口|443|
|默认UUID|d208b74d-9d22-442b-a64d-799500906dae</br>**注意：务必创建时自定义UUID码**|
...
|服务器地址|自选ip（如：`uicdn.cf`或`icook.tw`）</br>应用程序名.herokuapp.com|
|端口|443|
|密码|d208b74d-9d22-442b-a64d-799500906dae</br>**注意：务必创建时自定义UUID码**|
|传输协议|ws|
